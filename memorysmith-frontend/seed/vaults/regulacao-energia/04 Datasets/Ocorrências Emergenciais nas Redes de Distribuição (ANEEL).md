...
data_source: https://dadosabertos.aneel.gov.br/dataset/ocorrencias-emergenciais-nas-redes-de-distribuicao
coverage: a partir de 2017
---

> [!abstract]
> Microdados de cada ocorrência emergencial registrada nas redes de distribuição, um recurso por ano. Não cobre áreas de permissionárias (cooperativas). É a base granular por trás dos indicadores agregados de emergência.
...
| Portal | [dadosabertos.aneel.gov.br](https://dadosabertos.aneel.gov.br/dataset/ocorrencias-emergenciais-nas-redes-de-distribuicao) |
| Licença | Open Data Commons ODbL |
| Formatos | ZIP, PARQUET |
| Recursos | 20 (0 no DataStore, consultáveis por API) |
| Granularidade | ocorrência individual / município e conjunto |
...
curl -s "https://dadosabertos.aneel.gov.br/api/3/action/package_show?id=ocorrencias-emergenciais-nas-redes-de-distribuicao"
```

Rotina reexecutável: `data/scripts/aneel_ckan.py --dataset ocorrencias-emergenciais-nas-redes-de-distribuicao`
Destino: `data/raw/aneel/ocorrencias-emergenciais-nas-redes-de-distribuicao/<AAAA-MM-DD>/`
