...
data_source: https://dadosabertos.aneel.gov.br/dataset/transmissao-e-distribuicao
coverage: 2012 a 2018
---

> [!abstract]
> Totais de fiscalizações de transmissão e distribuição de 2012 a 2018. Para dados a partir de 2018, ver Termo de Notificação e Auto de Infração.
...
| Portal | [dadosabertos.aneel.gov.br](https://dadosabertos.aneel.gov.br/dataset/transmissao-e-distribuicao) |
...
curl -s "https://dadosabertos.aneel.gov.br/api/3/action/package_show?id=transmissao-e-distribuicao"
```

Rotina reexecutável: `data/scripts/aneel_ckan.py --dataset transmissao-e-distribuicao`
Destino: `data/raw/aneel/transmissao-e-distribuicao/<AAAA-MM-DD>/`
