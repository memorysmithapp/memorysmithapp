...
data_source: https://dadosabertos.aneel.gov.br/dataset/compensacao-financeira-royalties
coverage: histórico
---

> [!abstract]
> Histórico agregado dos valores de compensação financeira e royalties de Itaipu. A série viva está em CFURH.
...
| Portal | [dadosabertos.aneel.gov.br](https://dadosabertos.aneel.gov.br/dataset/compensacao-financeira-royalties) |
| Licença | Open Data Commons ODbL |
| Formatos | CSV, XML, JSON |
| Recursos | 4 (0 no DataStore, consultáveis por API) |
| Granularidade | ente federativo |
...
curl -s "https://dadosabertos.aneel.gov.br/api/3/action/package_show?id=compensacao-financeira-royalties"
```

Rotina reexecutável: `data/scripts/aneel_ckan.py --dataset compensacao-financeira-royalties`
Destino: `data/raw/aneel/compensacao-financeira-royalties/<AAAA-MM-DD>/`
