---
title: Decreto 12.068-2024 03
aliases:
  - Decreto 12.068 Capítulo III
  - Instrução Processual da Prorrogação
tags:
  - legislacao
  - concessoes
  - prazos
...
```mermaid
timeline
    title Prazos do rito ordinário (contados do vencimento do contrato)
    36 meses antes : Concessionária protocola requerimento na ANEEL (art. 7º)
    21 meses antes : ANEEL encaminha recomendação ao MME (art. 8º)
    18 meses antes : MME publica decisão de prorrogar ou licitar (art. 9º)
    90 dias apos convocacao : Concessionária assina o termo aditivo (art. 9º, § 1º)
```
