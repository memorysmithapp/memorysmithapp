...
```mermaid
flowchart TD
    A[Requerimento à ANEEL<br/>36 meses antes] --> B{Art. 2º<br/>serviço adequado?}
    B -->|Sim| C[Recomendação da ANEEL ao MME<br/>21 meses antes]
    B -->|Falha econômico-financeira| D[Aporte de capital<br/>art. 3º]
    B -->|Falha de continuidade| E[Plano de Resultados<br/>art. 11, II - só na antecipação]
    D --> C
    E --> C
    C --> F[Decisão do MME<br/>18 meses antes]
    F -->|Prorrogar| G[Assinatura do termo aditivo<br/>90 dias da convocação]
    F -->|Licitar| H[Licitação art. 13]
    B -->|Caducidade declarada| I[Requerimento indeferido<br/>art. 2º, § 11]
```
